...
namespace TabletFriend.Actions
{
	public class ClickAction : ButtonAction
	{
		...
		public async override Task Invoke()
		{
			...
			MouseOperations.MousePoint mp = new MouseOperations.MousePoint(int.Parse(x), int.Parse(y));

			// TODO: just for some testing
			//MouseOperations.MousePoint mp = MouseOperations.GetCursorPosition();
			//System.Threading.Thread.Sleep(1000);
            //await WindowsInput.Simulate.Events().Click($"{mp.X},{mp.Y}").Invoke();
			//mp.X += 100;
